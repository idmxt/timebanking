      ...
      <div className="max-w-7xl mx-auto px-4 pt-12 pb-8">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-8">
          <div className="max-w-2xl">
            <h1 className="text-4xl sm:text-6xl font-display font-medium tracking-tight mb-4 text-text-primary leading-[1.1]">
          ...
          {isAuthenticated && (
            <Link
              to="/services/create"
              className="btn-primary group !py-5 !px-8 flex items-center gap-3 transition-all hover:scale-105 active:scale-95"
            >
              <Plus size={24} strokeWidth={2.5} />
              <span className="font-bold">Создать услугу</span>
            </Link>
          )}
        </div>
      </div>
